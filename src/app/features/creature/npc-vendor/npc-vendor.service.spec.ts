...
describe('NpcVendorService', () => {
  ...
  it(
    'should cache properly the extendedCost',
    waitForAsync(async () => {
      const service: NpcVendorService = TestBed.inject(NpcVendorService);
  ...
  it(
    'should parse the ExtendedCost with partial values',
    waitForAsync(async () => {
      const mockItemExtendedCost = {
        id: 1,
        reqHonorPoints: 0,
  ...
  it(
    'should parse the ExtendedCost with empty values',
    waitForAsync(async () => {
